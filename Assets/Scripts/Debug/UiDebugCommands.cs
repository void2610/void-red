...
{
    [LiminalCommand("UI/ListButtons", Description = "押下可能なボタンの GameObject 名をカンマ区切りで返す")]
    public string ListButtons() => string.Join(",", ActiveButtons().Select(b => b.name).Distinct());
