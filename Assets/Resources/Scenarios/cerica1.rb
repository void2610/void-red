...
portrait :cerica, 'Character/Cerica/Normal.png'
say :player, '「……分からない。思い出せないの。名前も」', display_as: '■■■'
