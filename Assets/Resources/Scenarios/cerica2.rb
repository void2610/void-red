...
say :cerica, '「ええ。今回のオークションで提示された記憶よ」'
narration '（札には短い言葉が刻まれている）'
narration '壊れた約束：交わされた約束は果たされず、信頼が静かに失われた。'
narration '信じた罰：何もかも信じていた自分が、一番の愚か者だったと気づかされた。'
...
portrait :cerica, 'Character/Cerica/Normal.png'
narration '（セリカの声が、静かに、でも強く響いた）'
say :cerica, '「あなたは探さなければならない。 自分がここに来た理由を」'
say :cerica, "「それまで、あなたはくじけてはだめ。\nあなた自身を取り戻せるのは、あなたしかいないのよ」"
say :cerica, '「闘志を捨ててはだめ。 ここで、感情をぶつけなさい」'
say :cerica, '「ここでは、苦しみながらもがく者だけが、すべてを手に入れるわ」'
