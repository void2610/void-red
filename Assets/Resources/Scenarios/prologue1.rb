...
say :player, '……っ！？'
say :player, 'じゃあ……私が何も思い出せないのって……'
say :player, 'あなたのせい……？'
say :player, '返してよ……私の記憶！'

say :alv, 'それはできません。'
say :alv, 'ここでは、自分の力で記憶を取り戻していただきます。'
say :alv, 'それが、この会場のルールです。'

say :player, '勝手に奪っておいて、ルール？'
say :player, 'ふざけないで。そんなの、従うわけ——'
...
say :player, '……もう……訳が分からない……。'
say :player, '言い返す気力もなくなってきた……'
